            ...
            1: [
                function (t, e, i) {
                    ...
                    (r = t("./PriorityQueue/AbstractPriorityQueue")),
                        (o = t("./PriorityQueue/ArrayStrategy")),
                        (n = t("./PriorityQueue/BinaryHeapStrategy")),
                        ...
                        function t(t) {
                            ...
                            for (
                                this.comparator =
                                    ...
                                    this.pageSize = (null != t ? t.pageSize : void 0) || 512,
                                    this.length = 0,
                                    h = 0;
                                1 << h < this.pageSize;
                            ...
                            if (((this._memory = []), (this._mask = this.pageSize - 1), t.initialValues)) for (s = t.initialValues, o = 0, a = s.length; a > o; o++) (u = s[o]), this.queue(u);
                        }
                        return (
                            (t.prototype.queue = function (t) {
                            ...
                            (t.prototype._bubbleUp = function (t, e) {
                                ...
                                for (
                                    i = this.comparator;
                                    t > 1 && ((r = t & this._mask), t < this.pageSize || r > 3 ? (o = (t & ~this._mask) | (r >> 1)) : 2 > r ? ((o = (t - this.pageSize) >> this._shift), (o += o & ~(this._mask >> 1)), (o |= this.pageSize >> 1)) : (o = t - 2), (a = this._read(o)), !(i(a, e) < 0));

                                )
                                    this._write(o, e), this._write(t, a), (t = o);
                            }),
                            (t.prototype._bubbleDown = function (t, e) {
                                var i, r, o, a, n;
                                for (n = this.comparator; t < this.length; )
                                    if (
                                        (t > this._mask && !(t & (this._mask - 1)) ? (i = r = t + 2) : t & (this.pageSize >> 1) ? ((i = (t & ~this._mask) >> 1), (i |= t & (this._mask >> 1)), (i = (i + 1) << this._shift), (r = i + 1)) : ((i = t + (t & this._mask)), (r = i + 1)),
                                        i !== r && r <= this.length)
                                    )
                    ...
                    e.exports = r = (function () {
                        function t(t) {
                            ...
                            (this.comparator =
                                ...
                                (this.length = 0),
                                (this.data = (null != (e = t.initialValues) ? e.slice(0) : void 0) || []),
                                this._heapify();
                        }
                        return (
                            (t.prototype._heapify = function () {
                                var t, e, i;
                                if (this.data.length > 0) for (t = e = 1, i = this.data.length; i >= 1 ? i > e : e > i; t = i >= 1 ? ++e : --e) this._bubbleUp(t);
                            }),
                            (t.prototype.queue = function (t) {
