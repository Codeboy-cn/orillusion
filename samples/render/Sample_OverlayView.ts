...
import { Engine3D, View3D, Scene3D, CameraUtil, AtmosphericComponent, HoverCameraController, Object3D, DirectLight, KelvinUtil, PlaneGeometry, VertexAttributeName, LitMaterial, MeshRenderer, BoxGeometry, SphereGeometry, CylinderGeometry, TorusGeometry, Vector2, Color, UnLitMaterial, Camera3D } from "@orillusion/core";
...
export class Sample_OverlayView {
    ...
    async run() {
        ...
        if (true) {
            ...
            engine.addOverlayView(overlayView);
        }
    }
