...
import { DDP_FRONT_TEX } from '../../passRenderer/oit/DualDepthPeelingRenderer';
 ...
 * with {@link TransparentDualDepthPeelingFeature}.
 *
 * Mirrors {@link TransparentResolveFeature}'s shape (private pipeline,
 ...
 * @group Graph
 */
export class TransparentDualDepthPeelingResolveFeature extends RenderFeature {
    public readonly name = 'TransparentDualDepthPeelingResolveFeature';
    public readonly stage = RenderStage.AfterTransparent;
    public readonly reads = [COLOR_BUFFER, DDP_FRONT_TEX];
